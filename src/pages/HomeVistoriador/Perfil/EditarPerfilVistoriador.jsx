...
import './EditarPerfilVistoriador.css';
  ...
  const handleSave = async () => {
    ...
    try {
      const response = await fetch(
        `http://localhost:3001/api/funcionarios/${vistoriadorId}/atualizar-com-imagem`,
        {
          method: 'PUT',
          body: form
        }
      ...
      navigate(`/vistoriador/perfil-vistoriador/${vistoriadorId}`);
    } catch (error) {
    ...
    <div className="perfil-container">
      <header className="navbar">
        ...
        <nav className={`nav-links ${menuOpen ? 'open' : ''}`}>
          ...
          <a onClick={() => navigate('/vistoriador/realizar-vistoria')}>Minhas Vistorias</a>
